...
def _formation_data(cfg: NetConfig, agent_id: int, r_i: np.ndarray, r_neighbors: List[np.ndarray], neighbors: List[int]):
...
def _solve_single_integrator(
    ...
    c_i, Y_mat, bary_y, bary_r = _formation_data(cfg, agent_id, r_i, r_neighbors, neighbors)
    ...
    out = {
        ...
        "diam_C": float(diam_C),
        "rhs0_norm_y0_minus_bary": float(rhs0),
